/*/////////////////////////////////////////////////////////////////////////
 ...
 //   Some portions are based on ideas from Readability (c) Arc90 Inc     //
 //   and Safari Reader (c) Apple Inc.                                    //
 //                                                                       //
 /////////////////////////////////////////////////////////////////////////*/
...
function A(a, b) {
    ...
    if (b && document.body.scrollTop == 0) {
        ...
        if (c.top + c.height / 2 < window.innerHeight) {
            if (c = document.elementFromPoint(c.left + c.width / 2, c.top + c.height / 2))for (; c != a && (c = c.parentElement););
            if (c != a)return false
        }
    }
    return true
...
function ba(a) {
    ...
    this.L = function () {
        ...
        for (var c = 2, e = null; c-- > 0;) {
            ...
            if (e.C())return null;
            if (e.z())e = null; else if (e.w())e = null; else {
                b = v(e.element);
        ...
        for (var b = this.a.element, c = 0; c < 3 && b; c++, b = b.parentNode) {
            ...
            if (e && e.length) {
                ...
                for (var d, f = v(E(this)), h = 0; h < e.length; h++) {
                    d = e[h];
                    if (!d || !d.d())break;
                    if (!d.C())if (!d.z())if (!d.w())if (!(r(d.element).height < 50 && r(this.a.element).width != r(d.element).width)) {
                        var k = v(d.element);
    ...
    this.M = function () {
        ...
        var e = c.offsetLeft + c.width / 2, d = c.offsetTop, f = d;
        ...
        for (var h = v(E(this)), k = this.contentDocument.querySelectorAll("h1, h2, h3, h4, h5, .headline, .article_title, #hn-headline"), l, n = 0; n < k.length; n++) {
            var q = k[n], x = q.innerText;
            if (!(x.length < 8))if (A(q, true)) {
                var p = r(q), s = p.offsetLeft +
                    p.width / 2, m = s - e, w = p.offsetTop - f;
                w = Math.sqrt(m * m + w * w);
                m = Math.max(500 - w, 0);
                if (!(w > 500))if (!(p.width < c.width * 0.5))if (!(s < c.left || s > c.right)) {
                    p = y(q);
                    if (!(p < 12)) {
                        m *= p / 16;
                        ...
                        if (d.length > 0) {
                            ...
                            w = void 0;
                            var g = [];
                            if (p.length == 0)p = s.length; else if (s.length == 0)p = p.length; else {
                                for (var o = 0; o <= p.length; o++) {
                                    g[o] = [];
                                    g[o][0] = o
                                }
                                for (var i = 0; i <= s.length; i++)g[0][i] = i;
                                for (o = 1; o <= p.length; o++)for (i = 1; i <= s.length; i++) {
                                    w =
    ...
    this.q = function (b, c) {
        ...
        var d = /class|style|align/i, f = {
            FORM: 1, IFRAME: 1,
            SCRIPT: 1, STYLE: 1, LINK: 1
        }, h = {DIV: 1, TABLE: 1, OBJECT: 1, UL: 1}, k = {I: 1, EM: 1}, l = {
            B: 1,
            STRONG: 1,
            H1: 1,
            H2: 1,
            ...
            H5: 1,
            H6: 1
        }, n = [], q = 0, x = 0, p = 0, s = 0, m = b, w = window, g = c;
        G(this);
        for (var o = this.l; m;) {
            var i = null, t = g.tagName;
            g.g = m;
            if (t in f)i = g; else if (m === o)i = g;
            var u;
            if (!i) {
                u = v(m);
            ...
            if (!i) {
                ...
                if (q) {
                    if (q === 1)if (r(m).width === r(b).width)g.setAttribute("class", "float full-width"); else {
                        g.setAttribute("class", "float " + u["float"]);
                        g.style.clear = u.clear
                    }
                    if (D = m.style.getPropertyValue("width"))g.style.width =
                        D; else if (I = w.getMatchedCSSRules(m, "", true))for (j = I.length - 1; j >= 0; j--)if (D = I[j].style.getPropertyValue("width")) {
                        g.style.width = D;
                        break
                    }
                    if (q === 1 && !D)g.style.width = r(m).width + "px"
                }
                if (t === "TABLE")x || (x = 1); else if (t === "IMG") {
                    ...
                    if (q) {
                        ...
                        j = r(m);
                        if (j.width < 128 && j.height < 128)g.setAttribute("class", "tinyImage"); else j.width / b.clientWidth > 0.6 && g.setAttribute("class",
                            "largeImage");
                        if (u["float"] !== "none") {
                            g.setAttribute("class", "float " + u["float"]);
                            g.style["float"] = u["float"];
                    ...
                    "SPAN")if (u.display === "block")g.style.display = "block"
            }
    ...
    this.$ = function (b, c, e) {
        var d = /article|body|content|entry|page|pagination|post|text/i, f = /comment|combx|disqus|contact|foot|link|masthead|media|meta|promo|related|scroll|shoutbox|sponsor|tags|widget|share|pagination/i;
        if (!b.parentElement)return false;
        if (b.tagName !== "OBJECT" && b.tagName !== "EMBED") {
            for (var h = b.childNodes.length, k = false, l = 0; l < h; l++) {
                var n = b.childNodes[l], q = n.nodeType;
        ...
        if (c.childElementCount ===
            ...
            if (l.tagName === "A" && l.getElementsByTagName("img").length == 0)if (y(l) / y(e) < 0.75)return true
        }
    ...
    this.t = function () {
        ...
        d = e.snapshotLength;
        for (f = 0; f < d; f++) {
            var h = e.snapshotItem(f), k = this.Z(h);
            if (k > c) {
                b = h;
                c = k
            }
    ...
    this.Z = function (b) {
        ...
        function e(o) {
            ...
            for (var t = 0; t < o.length; t++) {
                var u = o[t], j = u.indexOf("=");
                if (j === -1)i[u] = null; else i[u.substring(0, j)] = u.substring(j + 1)
            }
            return i
        }

        var d = 100, f = this.contentDocument.location;
        ...
        var h = r(b), k = r(this.a.element), l = Math.max(0, Math.max(k.top - (h.top + h.height), h.top - (k.top + k.height)));
        if (l > 125)return 0;
        ...
        for (var p = 0; p < n.length; p++) {
            ...
            if (m !== s) {
                ...
                if (c(m, s, h, this.o))x = Math.pow(1.5, p - n.length + 1); else k++
            }
            if (k > 1)return 0
        }
        if (b.search) {
            ...
            for (var g in linkParameters) {
                ...
                if (n !== f) {
                    if (n === null)n = "";
                    if (f === null)f = "";
                    if (f.length < n.length)k++; else if (c(n, f, h, this.o))x = Math.max(x, 1 / 1.5); else k++
                }
            }
        }
        if (!x)return 0;
...
function ca(a, b) {
    ...
    this.v = function () {
        ...
        h = r(this.element).width *
            0.2;
        var k = this.element.querySelectorAll("img"), l = k.length;
        for (f = 0; f < l; f++) {
            var n = r(k[f]);
        ...
        if (h.snapshotLength > 2)for (f = 0; f < h.snapshotLength; f++) {
            d = h.snapshotItem(f);
        ...
        d = e - c;
        k = this.i.length;
        for (f = e = c = 0; f < k; f++)if (l = this.i[f].parentNode) {
            e += y(l);
            c++
        }
        f = 16;
    ...
    this.aa = function (c) {
        var e = [];
        if (!c)return e;
        var d = {A: 1, DD: 1, DT: 1, OL: 1, OPTION: 1, PRE: 1, SCRIPT: 1, STYLE: 1, UL: 1, IFRAME: 1};
        ...
        for (var f = 0; f < c.snapshotLength; f++) {
            ...
            if (!d[h.parentNode.tagName])if (/\S/.test(h.nodeValue)) {
                var k = h.parentElement, l = k.parentElement || {};
    ...
    this.ba = function () {
        var c = z(this.element.innerText).length, e = 0, d = this.contentDocument.evaluate("*",
            this.element, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
        if (d.snapshotLength > 2)for (var f = 0; f < d.snapshotLength; f++) {
    ...
    this.z = function () {
        ...
        if (d)if (f.height / d < 180)return true;
        return false
    };
    this.w = function () {
...
var H, J, K = false, ha, L = 0, M = new ba(document), N, O = {}, ia, P, Q, S, T, U = [], ja = [], V = 1, ka = null, W, la = {
    "Times New Roman": {c: [15, 16, 19, 20, 22, 23, 26, 28, 37, 46], lineHeight: 1.34},
    Verdana: {c: [11, 13, 14, 16, 17, 19, 21, 23, 32, 39], lineHeight: 1.6},
    Tahoma: {c: [12, 13, 15, 17, 18, 20, 22, 25, 30, 38], lineHeight: 1.6},
    Georgia: {c: [13, 14, 16, 18, 20, 23, 26, 28, 35, 40], lineHeight: 1.34},
    Palatino: {c: [14, 16, 17, 18, 20, 22, 24, 26, 37, 46], lineHeight: 1.4},
    Cambria: {c: [14, 16, 17, 18, 20, 22, 24, 26, 37, 46], lineHeight: 1.4},
    "Segoe UI": {
        c: [14, 16, 17, 18, 20, 22, 24, 26, 37, 46],
        lineHeight: 1.4
    },
    "Book Antiqua": {c: [14, 16, 17, 18, 20, 22, 24, 26, 37, 46], lineHeight: 1.4}
};
function ma() {
    ...
    var a = window.getComputedStyle(document.body, null), b = document.createElement("div");
...
function pa() {
    chrome.extension.sendRequest({action: "openOptions"})
}
function qa() {
...
function sa() {
    var a = encodeURIComponent(G(M)), b = location.href;
    if (O.useGmail !== "true")location.href = "mailto:?subject=" + a + "&body=" + b; else chrome.extension.sendRequest({
        action: "newWindow",
...
function Aa(a) {
    var b = H.contentDocument, c = b.getElementById("btnImages");
...
function Z(a) {
    var b = H.contentDocument.getElementsByClassName("pageNumber"), c = b.length;
    if (c == 1 && a)b[0].style.display = "none"; else for (var e = 0; e < c; e++)b[e].textContent = a ? e + 1 + " of " + c : "Page " + (e + 1)
}
function Ca() {
    var a = H.contentDocument, b = a.getElementsByClassName("loader");
    b[b.length - 1].style.display = "none";
    b = a.getElementsByClassName("footer");
    b[b.length - 1].style.display = "block"
}
function Ba(a) {
    var b = H.contentDocument, c = b.getElementsByClassName("page")[0].cloneNode(true), e = c.getElementsByClassName("content")[0];
    e.innerHTML = "";
    e.appendChild(a);
...
function ya() {
    chrome.extension.sendRequest({action: "saveSettings", settings: {currentFontSizeIndex: S, imagesDisabled: T}})
}
function za(a) {
    chrome.extension.sendRequest({action: "newTab", url: a})
}
function X(a) {
    P ? a(P) : chrome.extension.sendRequest({action: "shortenUrl", url: document.location.href}, function (b) {
        P = b.url;
        P == undefined ? X(a) : a(P)
    })
}
function wa(a) {
    if (O.hotkeyEnabled === "true") {
        ...
        var e = b.shiftKey !== undefined ? b.shiftKey : true, d = b.altKey !== undefined ? b.altKey : false, f = b.keyIdentifier !== undefined ? b.keyIdentifier : "U+0050";
        if ((a.ctrlKey || a.metaKey) === (b.ctrlKey !== undefined ? b.ctrlKey : true) && a.shiftKey === e && a.altKey === d && a.keyIdentifier === f || H != null && K && a.keyIdentifier === "U+001B")chrome.extension.sendRequest({action: "handlePageActionClicked"})
    }
}
chrome.extension.onRequest.addListener(function (a, b, c) {
    switch (a.action) {
        case "toggleReader":
            ...
            O = a.settings;
            ia = a.favIconUrl;
            Q = O.currentFontFamily || "Palatino";
            S = O.currentFontSizeIndex;
            S = S !== undefined ? parseInt(S, 10) : 3;
            T = O.imagesDisabled === "true";
            if (H != null && K)oa(); else {
                K = true;
                if (!H) {
                    if (!N) {
...
}, typeof Components != "undefined" ? document : null);
if (window.location.protocol + "//" + window.location.host + "/" != window.location.href)if (F(M)) {
    chrome.extension.sendRequest({
        action: "showPageAction",
        finder: typeof Components != "undefined" ? M : null
    }, function (a) {
        O = a.settings
    });
    document.body.addEventListener("keydown", wa, false);
    M.t()
}
;